    ...
    const Button = ({ number }) => {
        return (
            <button
                ...
                className="btn-number bg-gray-700 h-10 w-10 rounded-full text-gray-200 focus:bg-gray-400 transition-all duration-150"
            >
                {number}
            </button>
        );
          ...
          {!isSubmitted &&(
            <div className="wrapper">
                ...
                <div className="text-center">
                    ...
                    className="btn-rating w-full text-white uppercase pt-3 pb-2 rounded-full">
                        Submit
                    </button>
                </div>
            </div>
...
const ThankYou = ({ items, setIsSubmitted }) => {
    return (
        <div className="wrapper">
            <img src={thanks} alt="thanks-ilustration" className="block mx-auto mb-5" />
            <div className="flex items-center justify-center">
              <p className="p-rating bg-gray-700 rounded-full text-center text-sm px-4 pt-1">You selected {items} out of 5</p>
            </div>
            
            <h2 className="text-gray-100 text-3xl my-6 text-center">
                Thank You!
            </h2>
